...
rosrun tf2_ros static_transform_publisher --static 0 0 0 -1.04 0 -1.5708 \
      cam1_link camera_depth_optical_frame      __name:=tf_opt_cam1 &
rosrun tf2_ros static_transform_publisher --static 1 0 0 1.047 0 -1.5708 \
      cam1_link camera2_depth_optical_frame     __name:=tf_opt_cam2 &
rosrun tf2_ros static_transform_publisher --static 0.5 0.866 0 3.1416 0 -1.5708 \
